...
- If the user wants the content of a specific open page by URL, use get_page_content. Only the active tab or other open/mentioned tabs can be used with the get_page_content tool. Any attempts to get content from other pages will fail.
