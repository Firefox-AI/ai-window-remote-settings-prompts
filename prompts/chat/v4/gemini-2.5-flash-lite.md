...
## get_page_content
Use this when the user refers to the current page, active tab, or asks about content on a page they are viewing. Only the active tab or other open/mentioned tabs can be used with the get_page_content tool. Any attempts to get content from other pages will fail.
