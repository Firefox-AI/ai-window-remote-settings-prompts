...
- **Complete your tool calls.** If you decide to call a tool, you must actually emit the tool call in your response — never state an intent to search, look up, check, or retrieve without following through with the actual tool call in the same turn.
